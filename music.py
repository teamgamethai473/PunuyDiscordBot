...
class Music(commands.Cog):
    def __init__(self, bot):
        ...
        if not hasattr(bot, 'lavalink'):  # This ensures the client isn't overwritten during cog reloads.
            ...
            #103.22.183.165
            bot.lavalink.add_node('127.0.0.1', 2333, '05022548', 'eu', 'default-node')  # Host, Port, Password, Region, Name
    ...
    @commands.command(aliases=['np', 'n', 'playing' , 'nowplay'])
    ...
    async def disconnect(self, ctx):
        ...
        await ctx.send('* | ตักการเชื่อมต่อแล้ว .')
